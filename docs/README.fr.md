...
| [YouTube_Series](project/YouTube_Series.fr.md) | le plan de la série — un pilote et quatre blocs (environnement & CI/CD, sauvegarde, coffre-fort, interface) |
| [episode-01](project/episode-01-vision-architecture.fr.md) | script de tournage du **pilote** (ex-épisode 1) — plus `episode-01-narration.fr.txt` (narration seule, pour la synthèse vocale) et `episode-01.fr.srt` (sous-titres) |
